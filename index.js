...
function updateList(){
    ...
    for(var i = 0; i < cities.length; i++){
        list.innerHTML += `<li style="display:flex; gap:5px;">${cities[i]} <span><svg onclick="deleteItem(${i})" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
